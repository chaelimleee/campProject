 ...
 * leee
 *  게터세터 없던거 다 넣음. 수정완.
 * leee enabled 없앰. > DB컬럼에 없고, 없애도 될듯.
 * leee 수정
 * @author oracle
 *
 */
...
//	private int enabled; 
	 ...
	 * 
	 * --> 강사님 말씀. 제약사항에 너무 얽매이지 말고 일단 하고 나중에 add하셈.
	 * @param board
	 */
	// BoardDTO -> BoardVO
...
//        this.enabled = board.getEnabled();
        this.boardPass = board.getBoardPass();//0525 song
    }
    /**
     * 수정 완. lee
     * @param map
    ...
    public BoardVO(Map<String, Object> map) {
        ...
        this.boardPass = (String)map.get("boardPass");// 0525 song
	...
	public String toString() {
		...
		builder.append("BoardVO [boardCode=").append(boardCode)
				...
				.append(", boardPass=").append(boardPass) //0525 song
				.append("]");
