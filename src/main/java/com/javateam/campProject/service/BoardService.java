...
import com.javateam.campProject.dao.BoardDAO;
...
//	}
	...
	public int selectBoardsCountBySearching(String searchKey, String searchWord) {
		...
		*/
		//0514 song 수정 : 원글만 포함(댓글 제외) 검색
		return searchKey.equals("boardTitle") ? boardDAO.countByboardTitleContainingAndBoardOrigin(searchWord, 0) :
			   searchKey.equals("boardContent") ? boardDAO.countByBoardContentContainingAndBoardOrigin(searchWord, 0) : 
			   boardDAO.countByMemberNickContainingAndBoardOrigin(searchWord, 0);// 0424 song memberEmail->MemberNick,0514 0추가(원글)	
	}
...
//	}
	...
	public List<BoardVO> selectBoardsBySearching(int currPage, int limit, String searchKey, String searchWord) {
		...
		return searchKey.equals("boardTitle") ? boardDAO.findByboardTitleContaining(searchWord, pageable).getContent() :
			  ...
			  // boardDAO.findByMemberNickAndBoardOrigin(searchWord, pageable, 0).getContent();//0514복붙
			   boardDAO.findByMemberNickContainingAndBoardOrigin(searchWord, pageable, 0).getContent();//0514복붙
	}
